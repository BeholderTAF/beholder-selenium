...
import br.ufmg.dcc.saotome.beholder.selenium.validators.SeleniumComponentValidator;
...
public class SeleniumValidatorBuilder implements ValidatorBuilder {
    ...
    @Override
    public ComponentValidator componentAssertInstance() {
    	return new SeleniumComponentValidator();
    }
